                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
                            ...
                            {(currentStart || currentEnd) && (
                                <button onClick={resetDates} style={{ background: 'none', border: 'none', color: '#9CA3AF', fontSize: '15px', cursor: 'pointer', padding: '0 4px', lineHeight: 1 }} title="날짜 초기화">✕</button>
                            )}
                        </div>
                        <div style={{ width: '1px', height: '36px', backgroundColor: '#E5E7EB', flexShrink: 0 }} />
                        <select
